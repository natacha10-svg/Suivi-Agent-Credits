...
@Component({
  selector: 'app-localiser-client',
  templateUrl: './localiser-client.page.html',
  styleUrls: ['./localiser-client.page.scss'],
})
export class LocaliserClientPage implements OnInit {
